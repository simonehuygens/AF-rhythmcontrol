...
For more information on the input parameters and methods, we refer to the technical report or scienfitif manuscript.
...
d_rc               <- (1+d_rc)^cl-1                # discount rate costs to cycle length
d_re               <- (1+d_re)^cl-1                # discount rate effects to cycle length
...
# Probability of recurrence of AF after CA after 1 year (Source: meta-analysis Cochrane Nederland and Vektis) 
...
outcomes <- MicroSim(l_params, n_i, df_X, TRT1 = "CA", TRT2 = "AAD", TRT3 = "AAD", TRT4 = "AAD", TRT5 = "AAD", TRT6 = "CA", seed = 1)

results_ce1 <- t(data.frame(Cost               = outcomes$tc_hat,
                            QALYs              = outcomes$te_hat,
                            LYs                = outcomes$tLY_hat,
                            LYs_undiscounted   = outcomes$tLY_undisc_hat,
                            Time_in_line1      = outcomes$t_L1,
                            Time_in_line2      = outcomes$t_L2,
                            Time_in_line3      = outcomes$t_L3,
                            Time_in_line4      = outcomes$t_L4,
                            Time_in_line5      = outcomes$t_L5,
                            Time_in_line6      = outcomes$t_L6,
                            Time_discontinued  = outcomes$t_noTrt,
                            Prop_in_line1      = outcomes$p_L1,
                            Prop_in_line2      = outcomes$p_L2, 
                            Prop_in_line3      = outcomes$p_L3,
                            Prop_in_line4      = outcomes$p_L4,
                            Prop_in_line5      = outcomes$p_L5, 
                            Prop_in_line6      = outcomes$p_L6, 
                            Prop_discontinued  = outcomes$p_noTrt)
)
results_ce1
...
## 06.5 Cost-effectiveness planes (CE-plane) and cost-effectiveness acceptability curves (CEAC)
...
## 06.6 Value of information analysis & population impact
```{R}
knitr::opts_chunk$set(eval = FALSE)
